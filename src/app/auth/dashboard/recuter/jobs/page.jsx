...
const VideoIcon = (props) => (
  <svg aria-hidden="true" fill="none" focusable="false" height="1em" role="presentation" viewBox="0 0 24 24" width="1em" {...props}>
    <path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
  </svg>
);
...
const RecruiterJobs = async () => {
  ...
  return (
    <div className="w-full p-6 max-w-[1200px] mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-bold tracking-tight text-neutral-800">Recruiter Manage All Jobs</h2>
        <p className="text-sm text-neutral-500">View, edit, and keep track of your posted company listings.</p>
      </div>
                  ...
                  <Table.Row key={jobId}>
                    ...
                    <Table.Cell>
                      <div className="flex flex-col">
                        <span className="font-semibold text-neutral-700">{job.jobTitle}</span>
                        <span className="text-xs text-neutral-400 capitalize">{job.jobCategory}</span>
                      </div>
                    </Table.Cell>
